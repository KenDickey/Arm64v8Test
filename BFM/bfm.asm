...
bfm     file format elf64-littleaarch64
...
0000000000000680 <.plt>:
 ...
 684:	90000090 	adrp	x16, 10000 <__FRAME_END__+0xf660>
...
00000000000006f0 <_start>:
 ...
 708:	90000080 	adrp	x0, 10000 <__FRAME_END__+0xf660>
 70c:	f947e800 	ldr	x0, [x0, #4048]
 710:	90000083 	adrp	x3, 10000 <__FRAME_END__+0xf660>
 714:	f947e463 	ldr	x3, [x3, #4040]
 718:	90000084 	adrp	x4, 10000 <__FRAME_END__+0xf660>
...
0000000000000728 <call_weak_fn>:
 728:	90000080 	adrp	x0, 10000 <__FRAME_END__+0xf660>
...
0000000000000740 <deregister_tm_clones>:
 ...
 760:	90000081 	adrp	x1, 10000 <__FRAME_END__+0xf660>
...
0000000000000778 <register_tm_clones>:
 ...
 79c:	90000082 	adrp	x2, 10000 <__FRAME_END__+0xf660>
...
00000000000007b8 <__do_global_dtors_aux>:
 ...
 7d0:	90000080 	adrp	x0, 10000 <__FRAME_END__+0xf660>
...
0000000000000800 <frame_dummy>:
 800:	90000080 	adrp	x0, 10000 <__FRAME_END__+0xf660>
 ...
 814:	d503201f 	nop
 818:	90000081 	adrp	x1, 10000 <__FRAME_END__+0xf660>
...
*/
 ...
 858:	d299bde0 	mov	x0, #0xcdef                	// #52719
 85c:	f2b13560 	movk	x0, #0x89ab, lsl #16
 860:	f2c8ace0 	movk	x0, #0x4567, lsl #32
 864:	f2e02460 	movk	x0, #0x123, lsl #48
 868:	f9000fa0 	str	x0, [x29, #24]
  uint64_t result = bitMove( arg ); /* 11292276 );*/
 86c:	f9400fa0 	ldr	x0, [x29, #24]
 870:	97fffff2 	bl	838 <bitMove>
 874:	f9000ba0 	str	x0, [x29, #16]
  printf( "\n   Arg is hex: %lx ", arg );
 878:	90000000 	adrp	x0, 0 <_init-0x660>
 87c:	91252000 	add	x0, x0, #0x948
 880:	f9400fa1 	ldr	x1, [x29, #24]
 884:	97ffff97 	bl	6e0 <printf@plt>
  printf( "\nBFI  X0, XZR, #6=startbit6, #8=width" );
 888:	90000000 	adrp	x0, 0 <_init-0x660>
 88c:	91258000 	add	x0, x0, #0x960
 890:	97ffff94 	bl	6e0 <printf@plt>
  printf( "\nResult is hex: %lx \n", result );
 894:	90000000 	adrp	x0, 0 <_init-0x660>
 898:	91262000 	add	x0, x0, #0x988
 89c:	f9400ba1 	ldr	x1, [x29, #16]
 8a0:	97ffff90 	bl	6e0 <printf@plt>
}
 8a4:	d503201f 	nop
...
00000000000008b0 <__libc_csu_init>:
 ...
 8bc:	90000095 	adrp	x21, 10000 <__FRAME_END__+0xf660>
 8c0:	a90153f3 	stp	x19, x20, [sp, #16]
 8c4:	90000094 	adrp	x20, 10000 <__FRAME_END__+0xf660>
