...
immed64:     file format elf64-littleaarch64
...
0000000000000680 <.plt>:
 ...
 684:	90000090 	adrp	x16, 10000 <__FRAME_END__+0xf6b8>
...
00000000000006f0 <_start>:
 ...
 708:	90000080 	adrp	x0, 10000 <__FRAME_END__+0xf6b8>
 70c:	f947e800 	ldr	x0, [x0, #4048]
 710:	90000083 	adrp	x3, 10000 <__FRAME_END__+0xf6b8>
 714:	f947e463 	ldr	x3, [x3, #4040]
 718:	90000084 	adrp	x4, 10000 <__FRAME_END__+0xf6b8>
...
0000000000000728 <call_weak_fn>:
 728:	90000080 	adrp	x0, 10000 <__FRAME_END__+0xf6b8>
...
0000000000000740 <deregister_tm_clones>:
 ...
 760:	90000081 	adrp	x1, 10000 <__FRAME_END__+0xf6b8>
...
0000000000000778 <register_tm_clones>:
 ...
 79c:	90000082 	adrp	x2, 10000 <__FRAME_END__+0xf6b8>
...
00000000000007b8 <__do_global_dtors_aux>:
 ...
 7d0:	90000080 	adrp	x0, 10000 <__FRAME_END__+0xf6b8>
...
0000000000000800 <frame_dummy>:
 800:	90000080 	adrp	x0, 10000 <__FRAME_END__+0xf6b8>
 ...
 814:	d503201f 	nop
 818:	90000081 	adrp	x1, 10000 <__FRAME_END__+0xf6b8>
...
0000000000000838 <da_test>:
 838:	10000081 	adr	x1, 848 <da_test+0x10>
 83c:	d61f0020 	br	x1
 840:	aa221100 	orn	x0, x8, x2, lsl #4
 844:	aabbccdd 	orn	x29, x6, x27, asr #51
 848:	f85f8020 	ldur	x0, [x1, #-8]
 84c:	d503201f 	nop
 850:	d65f03c0 	ret

0000000000000854 <main>:
 854:	a9be7bfd 	stp	x29, x30, [sp, #-32]!
 858:	910003fd 	mov	x29, sp
 85c:	97fffff7 	bl	838 <da_test>
 860:	f9000fa0 	str	x0, [x29, #24]
 864:	90000000 	adrp	x0, 0 <_init-0x660>
 868:	91248000 	add	x0, x0, #0x920
 86c:	f9400fa2 	ldr	x2, [x29, #24]
 870:	f9400fa1 	ldr	x1, [x29, #24]
 874:	97ffff9b 	bl	6e0 <printf@plt>
 878:	d503201f 	nop
 87c:	a8c27bfd 	ldp	x29, x30, [sp], #32
 880:	d65f03c0 	ret
 884:	00000000 	.inst	0x00000000 ; undefined

0000000000000888 <__libc_csu_init>:
 888:	a9bc7bfd 	stp	x29, x30, [sp, #-64]!
 88c:	910003fd 	mov	x29, sp
 890:	a9025bf5 	stp	x21, x22, [sp, #32]
 894:	90000095 	adrp	x21, 10000 <__FRAME_END__+0xf6b8>
 898:	a90153f3 	stp	x19, x20, [sp, #16]
 89c:	90000094 	adrp	x20, 10000 <__FRAME_END__+0xf6b8>
 8a0:	9136a2b5 	add	x21, x21, #0xda8
 8a4:	9136c294 	add	x20, x20, #0xdb0
 8a8:	cb150294 	sub	x20, x20, x21
 8ac:	a90363f7 	stp	x23, x24, [sp, #48]
 8b0:	aa0203f6 	mov	x22, x2
 8b4:	2a0003f8 	mov	w24, w0
 8b8:	aa0103f7 	mov	x23, x1
 8bc:	97ffff69 	bl	660 <_init>
 8c0:	9343fe94 	asr	x20, x20, #3
 8c4:	b4000154 	cbz	x20, 8ec <__libc_csu_init+0x64>
 8c8:	d2800013 	mov	x19, #0x0                   	// #0
 8cc:	f8737aa3 	ldr	x3, [x21, x19, lsl #3]
 8d0:	aa1603e2 	mov	x2, x22
 8d4:	aa1703e1 	mov	x1, x23
 8d8:	2a1803e0 	mov	w0, w24
 8dc:	91000673 	add	x19, x19, #0x1
 8e0:	d63f0060 	blr	x3
 8e4:	eb13029f 	cmp	x20, x19
 8e8:	54ffff21 	b.ne	8cc <__libc_csu_init+0x44>  // b.any
 8ec:	a94153f3 	ldp	x19, x20, [sp, #16]
 8f0:	a9425bf5 	ldp	x21, x22, [sp, #32]
 8f4:	a94363f7 	ldp	x23, x24, [sp, #48]
